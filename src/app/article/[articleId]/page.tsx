...
export default function Home() {
  ...
  return (
    <main>
      <Navbar />
      <section className="merchandise" id="merchandise">
        <div className="relative h-[500px]">
          <Image
            src={articleData[0].imageSrc}
            width={1000}
            height={500}
            alt="BG"
            className="w-full h-[500px] object-cover"
          />
          <div className="bg-black w-full h-[500px] absolute top-0 left-0 bg-opacity-50 backdrop-blur-sm"></div>
        ...
        <div className="max-w-7xl mx-auto py-10">
          <div className="grid grid-cols-1 gap-10 mt-20">
            <div className="col-span-3">
              ...
              <p className="font-extralight">{articleData[0].description}</p>
            </div>
            <div className="pt-10 border-t-[1px] border-t-white">
              <div className="grid grid-cols-4 gap-4">
                {articleDataFull.map((product) => (
                  <CardArticle
                    key={product.id}
                    product={product}
